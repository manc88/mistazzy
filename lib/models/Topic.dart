...
//- 1 если голосование
  ...
  Topic.fromPreview(Map<String, dynamic> props) {
    ...
    this.created = new DateTime.fromMicrosecondsSinceEpoch(props['created']);
